...
5. Refer to the guidance at https://demo.fellesdatakatalog.digdir.no/publishing/about-harvesting if you're unfamiliar with the admin-portal.
...
> [!NOTE]
> If you choose not to use this repo as a harvest endpoint, you should include the organization number 555111098 or the name of this repo (hackathon-hc-card) somewhere in the URL i.e., the specification file name. (We use this info to filter out relevant logs to slack)
7. Save the data source and click harvest.
> [!TIP]
> You can return here later to manually harvest any recent changes.
...
9. If the file isn't accepted, we'll likely have some log-output referring to why. We've set up a slack-channel that receives any harvest error/warning related to this hackathon. Reach out to us if you want to be added to this channel.
